...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(4294376698),
    value: Color(4294376698),
    light: ColorFamily(
      color: Color(4278217316),
      onColor: Color(4294967295),
      colorContainer: Color(4288541417),
      onColorContainer: Color(4278198302),
    ),
    ...
    dark: ColorFamily(
      color: Color(4286698957),
      onColor: Color(4278204211),
      colorContainer: Color(4278210635),
      onColorContainer: Color(4288541417),
    ),
